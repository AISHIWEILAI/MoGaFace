...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    landmark2d = cam_info.landmark2d
    all_view_fig_path = cam_info.all_view_fig_path
    lip_crop = None

    if args.resolution in [1, 2, 4, 8]:
        image_width, image_height = (round(orig_w/(resolution_scale * args.resolution)),
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  ...
                  MV_images=None,
                  MV_image_path=all_view_fig_path,
                  image_name=cam_info.image_name, uid=id, 
                  timestep=cam_info.timestep, landmark2d=landmark2d, lip_crop=lip_crop,
